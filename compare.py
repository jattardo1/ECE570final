#UPLOAD THE IMAGES YOU WANT TO USE TO THE INTERNET TO GIVE THEM A LINK THEN PASTE THAT LINK IN THE CORRECT LOCATION IN THE CODE
...
if __name__ == '__main__':
	...
	try:
		...
		face_comparing(app_, image1, image2, "Old")
